        ...
        <nav className="sticky top-0 z-50 bg-brand-offwhite/90 backdrop-blur-sm border-b border-slate-200">
            <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <button className="text-sm font-medium text-brand-slate-text hover:text-brand-indigo transition">
                        Login
                    </button>
                    <button className="bg-brand-indigo text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-brand-indigo-dark transition">
                        Get Started
                    </button>
                </div>
            </div>
